...
@app.route('/')
def home():
    return "🤖 𝐑𝐈𝐘𝐀𝐃 𝐗 𝐇𝐎𝐒𝐓 🦁 is Running!"
@app.route('/health')
def health():
...
# --- Configuration ---
TOKEN = '8384261103:AAGWZdsvCKcs6p24r6-f2b9RBr-q9NwEqdU'
OWNER_ID = 8124942237
ADMIN_ID = 8124942237
YOUR_USERNAME = '@RIYAD_CODER'
UPDATE_CHANNEL = 'https://t.me/RIYAD_PRM_AI_BOT'
# Folder setup
...
def run_script(script_path, script_owner_id, user_folder, file_name, message_obj, attempt=1):
    ...
    try:
        ...
        terminal_msg = f"""
╔══════════════════════════════════════╗
║      🚀 <b>ㅤ𝐑𝐈𝐘𝐀𝐃 𝐗 𝐇𝐎𝐒𝐓: STARTING SCRIPT</b> 🚀 ║
╠══════════════════════════════════════╣
...
"""
        ...
        if process.poll() is None:
            success_msg = f"""
╔══════════════════════════════════════╗
║     ✅ <b>ㅤ𝐑𝐈𝐘𝐀𝐃 𝐗 𝐇𝐎𝐒𝐓: SCRIPT RUNNING</b> ✅   ║
╠══════════════════════════════════════╣
...
"""
            ...
            error_msg = f"""
╔══════════════════════════════════════╗
║     ❌ <b>ㅤ𝐑𝐈𝐘𝐀𝐃 𝐗 𝐇𝐎𝐒𝐓: SCRIPT FAILED</b> ❌     ║
╠══════════════════════════════════════╣
║ 📄 <b>File:</b> <code>{file_name[:25]}</code>
...
def run_js_script(script_path, script_owner_id, user_folder, file_name, message_obj, attempt=1):
    ...
    try:
        ...
        terminal_msg = f"""
╔══════════════════════════════════════╗
║      🟢 <b>ㅤ𝐑𝐈𝐘𝐀𝐃 𝐗 𝐇𝐎𝐒𝐓: STARTING NODE.JS</b> 🟢║
╠══════════════════════════════════════╣
║ 📄 File: <code>{file_name[:25]}</code>
║ 👤 User: {script_owner_id}
║ 🔄 Attempt: {attempt}/{max_attempts}
...
"""
        ...
        if process.poll() is None:
            success_msg = f"""
╔══════════════════════════════════════╗
║     ✅ <b>ㅤ𝐑𝐈𝐘𝐀𝐃 𝐗 𝐇𝐎𝐒𝐓: NODE.JS RUNNING</b> ✅  ║
╠══════════════════════════════════════╣
║ 📄 <b>File:</b> <code>{file_name[:25]}</code>
║ 🆔 <b>PID:</b> {process.pid}
║ ⏱️ <b>Started:</b> {datetime.now().strftime('%H:%M:%S')}
...
"""
            ...
            error_msg = f"""
╔══════════════════════════════════════╗
║     ❌ <b>ㅤ𝐑𝐈𝐘𝐀𝐃 𝐗 𝐇𝐎𝐒𝐓: NODE.JS FAILED</b> ❌    ║
╠══════════════════════════════════════╣
║ 📄 <b>File:</b> <code>{file_name[:25]}</code>
║ ❗ <b>Exit Code:</b> {process.returncode}
╠══════════════════════════════════════╣
...
def stats_command(message):
    ...
    user_id = message.from_user.id
    msg = send_spinner_animation(message.chat.id, "𝐆𝐚𝐭𝐡𝐞𝐫𝐢𝐧𝐠 ㅤ𝐑𝐈𝐘𝐀𝐃 𝐗 𝐇𝐎𝐒𝐓 𝐬𝐭𝐚𝐭𝐬...", duration=2)
...
def speed_command(message):
    ...
    msg = send_spinner_animation(message.chat.id, "𝐓𝐞𝐬𝐭𝐢𝐧𝐠 ㅤ𝐑𝐈𝐘𝐀𝐃 𝐗 𝐇𝐎𝐒𝐓 𝐬𝐩𝐞𝐞𝐝...", duration=2)
...
"""
    ...
    result_text = f"""
╔══════════════════════════════════════╗
║     ✅ <b>ㅤ𝐑𝐈𝐘𝐀𝐃 𝐗 𝐇𝐎𝐒𝐓 𝐁𝐑𝐎𝐀𝐃𝐂𝐀𝐒𝐓 𝐂𝐎𝐌𝐏𝐋𝐄𝐓𝐄</b> ✅ ║
╠══════════════════════════════════════╣
║
║  📤 𝐓𝐨𝐭𝐚𝐥: {total}
║  ✅ 𝐒𝐮𝐜𝐜𝐞𝐬𝐬: {success}
...
def subscribe_command(message):
    ...
    sub_text = f"""
╔══════════════════════════════════════╗
║      ✅ <b>ㅤ𝐑𝐈𝐘𝐀𝐃 𝐗 𝐇𝐎𝐒𝐓 𝐒𝐔𝐁𝐒𝐂𝐑𝐈𝐏𝐓𝐈𝐎𝐍</b> ✅   ║
╠══════════════════════════════════════╣
║
║  👤 𝐔𝐬𝐞𝐫: {target_user}
║  📅 𝐃𝐚𝐲𝐬: {days}
...
def handle_text(message):
    ...
    if text == "📢 Updates Channel":
        bot.send_message(message.chat.id, f"📢 𝐉𝐨𝐢𝐧 𝐨𝐮𝐫 ㅤ𝐑𝐈𝐘𝐀𝐃 𝐗 𝐇𝐎𝐒𝐓 𝐮𝐩𝐝𝐚𝐭𝐞𝐬:\n{UPDATE_CHANNEL}")
...
def show_user_files(message):
    ...
    user_id = message.from_user.id
    msg = send_spinner_animation(message.chat.id, "𝐋𝐨𝐚𝐝𝐢𝐧𝐠 ㅤ𝐑𝐈𝐘𝐀𝐃 𝐗 𝐇𝐎𝐒𝐓 𝐟𝐢𝐥𝐞𝐬...", duration=1)
    files = user_files.get(user_id, [])
    if not files:
        text = """
╔══════════════════════════════════════╗
║       📂 <b>ㅤ𝐑𝐈𝐘𝐀𝐃 𝐗 𝐇𝐎𝐒𝐓: YOUR FILES</b> 📂   ║
╠══════════════════════════════════════╣
║
...
def show_subscriptions(message):
    ...
    text = f"""
╔══════════════════════════════════════╗
║     💳 <b>ㅤ𝐑𝐈𝐘𝐀𝐃 𝐗 𝐇𝐎𝐒𝐓: SUBSCRIPTIONS</b> 💳    ║
╠══════════════════════════════════════╣
║
...
def confirm_delete_file(call, file_name):
    ...
    delete_text = f"""
╔══════════════════════════════════════╗
║       🗑️ <b>ㅤ𝐑𝐈𝐘𝐀𝐃 𝐗 𝐇𝐎𝐒𝐓: DELETING</b> 🗑️     ║
╠══════════════════════════════════════╣
║
║  📄 <code>{file_name[:25]}</code>
║  ⏳ 𝐏𝐥𝐞𝐚𝐬𝐞 𝐰𝐚𝐢𝐭...
...
def show_admin_logs(call):
    ...
    try:
        ...
        conn.close()
        if logs:
            text = "📋 <b>ㅤ𝐑𝐈𝐘𝐀𝐃 𝐗 𝐇𝐎𝐒𝐓: RECENT LOGS</b>\n"
            for log in logs:
                text += f"👤 {log[0]} | {log[1]}\n{log[2][:30]}...\n🕐 {log[3][:16]}\n"
        else:
            text = "📋 𝐍𝐨 𝐥𝐨𝐠𝐬."
...
def cleanup_on_exit():
    ...
    logger.info("𝐂𝐥𝐞𝐚𝐧𝐢𝐧𝐠 𝐮𝐩 ㅤ𝐑𝐈𝐘𝐀𝐃 𝐗 𝐇𝐎𝐒𝐓...")
    for script_key in list(bot_scripts.keys()):
        try:
            script_info = bot_scripts[script_key]
            kill_process_tree(script_info)
...
def main():
    ...
    logger.info("=" * 50)
    logger.info("🤖 𝐒𝐭𝐚𝐫𝐭𝐢𝐧𝐠 ㅤ𝐑𝐈𝐘𝐀𝐃 𝐗 𝐇𝐎𝐒𝐓 🦁 𝐁𝐨𝐭...")
    ...
    while True:
        try:
            ...
            logger.error(f"ㅤ𝐑𝐈𝐘𝐀𝐃 𝐗 𝐇𝐎𝐒𝐓 𝐞𝐫𝐫𝐨𝐫: {e}", exc_info=True)
            time.sleep(5)
